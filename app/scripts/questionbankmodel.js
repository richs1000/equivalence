...
QuestionBankModel.prototype.selectBlock = function() {
	...
	if(blockIndex == 0){
		...
		block = [startCode, val,funf , endCode, '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and<br/>', startCode, val2 ,  funf2, endCode];
		...
		block = [startCode, val, funf, endCode, andconcat, startCode, val2, funf2, funf3, endCode];
		...
		block = [startCode, funf, if1, then1, else1, endCode, andconcat, startCode, funf2, if2, endCode]
		...
		block = [startCode, val, val2,  funf, endCode, andconcat, startCode, val, funf2, val2, funf3, endCode]
		...
		block = [startCode, val, funf1, endCode, andconcat, startCode,  val, funf2, endCode]
